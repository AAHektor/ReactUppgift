  ...
  return (
    <div className="newsletter-container">
        ...
        <div className="input-group">                     
            ...
            <input id="input-mobile-tablet" className="form-input" type="email" placeholder="Your email"/>
            <input id="input-desktop" className="form-input" type="email" placeholder="Your Email" />
